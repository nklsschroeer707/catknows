...
Per community write `chapters/<slug>.md` with these five sections.
...
**5. Verdict** — one honest paragraph plus a one-word label:
...
inside matches what the ads promise outside.
