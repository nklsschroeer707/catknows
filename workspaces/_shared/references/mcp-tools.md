...
| `list_posts` | slug, limit=25, sort=activity\|new\|top_day\|top_week\|top_month\|top_year\|top_all, unread_only=false, category="" | title, author, likes, comment count, content, **post id**, `category`, `has_new_comments`. **Filter here instead of reading everything:** `unread_only` = only posts you haven't opened, `category` by name ("feedback") |
